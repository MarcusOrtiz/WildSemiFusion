...
class CustomDataset(Dataset):
    ...
    ['sampled_points', 'gt_sdfs', 'gt_confidences', 'gt_colors', 'gt_semantics', 'scan_indices', 'observed_pcd', 'mel_spectrum', 'gt_trav']
"""
    ...
    def __getitem__(self, idx):
        ...
        print(f"Num scans to sample: {num_scans_to_sample}", flush=True)
