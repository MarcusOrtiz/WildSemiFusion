...
class SemanticColorModelSimple(nn.Module):
    def __init__(self, num_bins, num_classes):
        super(SemanticColorModelSimple, self).__init__()
...
class SemanticColorModelLinear(nn.Module):
    def __init__(self, num_bins, num_classes):
        super(SemanticColorModelLinear, self).__init__()
...
class SemanticColorModelMLP(nn.Module):
    def __init__(self, num_bins):
        super(SemanticColorModelMLP, self).__init__()
        self.color_fusion_fc1 = nn.Linear(num_bins * 2, num_bins)
