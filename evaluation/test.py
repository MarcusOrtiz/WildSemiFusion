...
def main():
    ...
    logging.info("New state dict generated successfully")
    model.load_state_dict(new_state_dict)
    logging.info("Model state dict loaded successfully")

    os.makedirs(args.pcd_output, exist_ok=True)
    logging.info("PCD output directory created successfully")
    os.makedirs(args.confidence_output, exist_ok=True)
    logging.info("Confidence output directory created successfully")
