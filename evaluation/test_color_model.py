...
def test_color_model(base_model, color_expert_model, color_model, device, test_preloaded_data):
...
def main():
    ...
    print("Color expert model frozen successfully")
    ...
    print("Color model frozen successfully")
